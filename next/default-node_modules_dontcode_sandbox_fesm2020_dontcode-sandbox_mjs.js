...
/* harmony export */ });
/* harmony import */ var _WebSocketSubject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./WebSocketSubject */ 3153);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! rxjs */ 9346);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! rxjs */ 9904);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! rxjs */ 591);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! rxjs */ 6562);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! rxjs */ 745);
...
/* harmony import */ var _dontcode_plugin_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @dontcode/plugin-common */ 2916);
...
/* harmony import */ var _angular_architects_module_federation_runtime__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! @angular-architects/module-federation-runtime */ 4109);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! rxjs/operators */ 1353);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! rxjs/operators */ 3158);
...
class IndexedDbStorageService extends _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.AbstractDontCodeStoreProvider {
  ...
  searchEntities(position, ...criteria) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_29__.from)(this.ensurePositionCanBeStored(position, false).then(table => {
...
class RemotePluginLoaderService {
  ...
  loadModule(moduleDef) {
    ...
    return (0,_home_runner_work_preview_ui_preview_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield (0,_angular_architects_module_federation_runtime__WEBPACK_IMPORTED_MODULE_30__.loadRemoteModule)(moduleDef);
...
class GlobalPluginLoader {
  constructor(loader, changeService, previewManager) {
    ...
    this.subscribers = new rxjs__WEBPACK_IMPORTED_MODULE_31__.Subscriber();
   ...
   */
  initLoading() {
    this.subscribers.add(this.previewManager.receiveGlobalHandlers().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_32__.mergeMap)(config => {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_32__.mergeMap)(result => {
...
class MainComponent {
  constructor(provider, listenerService, ref, config) {
    ...
    this.ref = ref;
    this.config = config;
    this.context$ = rxjs__WEBPACK_IMPORTED_MODULE_33__.EMPTY;
    this.subscriptions = new rxjs__WEBPACK_IMPORTED_MODULE_28__.Subscription();
  ...
  ngOnInit() {
    ...
    this.context$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_34__.combineLatest)([this.listenerService.getConnectionStatus(), this.listenerService.getSessionIdSubject()]).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_27__.map)(status => {
      return {
        status: status[0],
        sessionId: status[1]
      };
...
class BaseAppComponent {
  ...
  ngOnInit() {
    ...
    this.pluginsLoaded = this.pluginLoader.loadPluginsFromRepository(repoUrl, 'assets/repositories/default.json').catch(reason => {
      ...
      this.subscription.add(this.provider.receiveCommands(_dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeModel.APP_SHARING, _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeModel.APP_SHARING_WITH_NODE).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_32__.mergeMap)(change => {
        if (change.type !== _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.ChangeType.DELETE) {
          if (change.value === 'No-one') {
            this.storeMgr.setProvider(this.storage);
            return rxjs__WEBPACK_IMPORTED_MODULE_33__.EMPTY;
...
class DevTemplateManagerService {
  ...
  getTemplates() {
    if (this.templates.length > 0) return (0,rxjs__WEBPACK_IMPORTED_MODULE_35__.of)(this.templates);else {
      ...
      }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_36__.catchError)(err => {
...
class ScreenComponent {
  constructor(route, provider, loader, injector) {
    ...
    this.injector = injector;
    this.subscriptions = new rxjs__WEBPACK_IMPORTED_MODULE_28__.Subscription();
    this.screenName$ = rxjs__WEBPACK_IMPORTED_MODULE_33__.EMPTY;
  }
  ngOnInit() {
    //super.ngOnInit();
