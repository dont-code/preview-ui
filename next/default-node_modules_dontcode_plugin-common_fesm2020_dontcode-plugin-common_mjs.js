...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ 7022);
...
/* harmony import */ var async_mutex__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! async-mutex */ 4361);
/* harmony import */ var _dontcode_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @dontcode/core */ 4348);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! rxjs/operators */ 635);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! rxjs/operators */ 9601);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! rxjs/operators */ 3158);
/* harmony import */ var primeng_dropdown__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! primeng/dropdown */ 6674);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/common */ 7863);
/* harmony import */ var primeng_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! primeng/api */ 3134);
...
AbstractDynamicComponent.ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
...
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AbstractDynamicComponent, [{
 ...
 */
const DONT_CODE_STORE_API_URL = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.InjectionToken('DontCodeStoreApiUrl');
/**
 * Enable the application to provide the url of the API for managing documents (used by image plugin)
 */
const DONT_CODE_DOC_API_URL = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.InjectionToken('DontCodeStoreDocUrl');
...
class AbstractDynamicLoaderComponent extends AbstractDynamicComponent {
  constructor(loader, injector, ref) {
     ...
     * @protected
     */
    this.componentInited = new rxjs__WEBPACK_IMPORTED_MODULE_8__.ReplaySubject();
  }
  /**
...
AbstractDynamicLoaderComponent.ɵfac = function AbstractDynamicLoaderComponent_Factory(t) {
  return new (t || AbstractDynamicLoaderComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ComponentLoaderService), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__.Injector), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__.ChangeDetectorRef));
};
...
class PluginHandlerHelper {
  ...
  initCommandFlow(provider, pointer, changeHandler) {
      ...
      for (const prop in json) {
        if (json.hasOwnProperty(prop)) {
          ...
          if (propType?.isArray() && subPropertyPointer.isProperty) {
            ...
            change = new _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.Change(_dontcode_core__WEBPACK_IMPORTED_MODULE_3__.ChangeType.RESET, pointer.position + '/' + prop, json[prop], subPropertyPointer);
  ...
  initOtherChangeListening(subElement, pointer) {
    if (this.provider && pointer) {
      ...
      this.subscriptions.add(this.provider.receiveCommands(filter).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.map)(change => {
  ...
  applyUpdatesToArrayAsync(target, targetMap, change, property, transform, parentPosition, applyProperty) {
    ...
    return this.mutex.runExclusive(() => {
      try {
        ...
        let itemId = subItem ? change.pointer.lastElement : _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeModelPointer.lastElementOf(change.pointer.containerPosition) ?? null;
        ...
        if (itemId != null && targetMap.has(itemId)) {
          ...
          futureTarget = (0,rxjs__WEBPACK_IMPORTED_MODULE_10__.of)(newTarget);
        }
        if (change.beforeKey) {
          ...
          case _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.ChangeType.RESET:
            if (propertyId != null) {
              ...
              if (!newTarget || newTarget && (!applyProperty || !applyProperty(newTarget, propertyId, change.value))) {
                ...
                futureTarget = (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.from)(transform(parentPointer, fullValue));
                /*                      }else {
              ...
              futureTarget = (0,rxjs__WEBPACK_IMPORTED_MODULE_11__.from)(transform(change.pointer, change.value));
            }
            break;
        ...
        if (futureTarget) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.firstValueFrom)(futureTarget.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.map)(result => {
            if (pos !== -1) {
            ...
            return target;
          }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_13__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.catchError)(error => {
...
class PluginBaseComponent extends AbstractDynamicLoaderComponent {
  ...
  updateValueOnFormChanges() {
    this.subscriptions.add(this.form.valueChanges.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.map)(value => {
  ...
  updateSubFieldsWithChange(change, subProperty, parentPosition) {
    return this.applyUpdatesToArrayAsync(this.fields, this.fieldsMap, change, subProperty, (position, value) => {
      ...
      switch (key) {
        case _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeModel.APP_FIELDS_NAME_NODE:
          elt.name = newVal;
          break;
        default:
          return false;
  ...
  rebuildForm() {
    ...
    for (const field of this.fields) {
      ...
      if (field.component != null) {
        ...
        this.form.registerControl(field.name, new _angular_forms__WEBPACK_IMPORTED_MODULE_1__.FormControl(val, _angular_forms__WEBPACK_IMPORTED_MODULE_1__.Validators.required));
      }
    }
...
PluginBaseComponent.ɵfac = function PluginBaseComponent_Factory(t) {
  return new (t || PluginBaseComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ComponentLoaderService), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__.Injector), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__.ChangeDetectorRef));
};
...
class AbstractReferenceComponent extends AbstractDynamicComponent {
  constructor(modelMgr, storeMgr) {
    ...
    if (modelMgr == null) this.modelMgr = _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.dtcde.getModelManager();
    if (storeMgr == null) this.storeMgr = _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.dtcde.getStoreManager();
  }
  canProvide(key) {
  ...
  setTargetEntitiesWithName(entityName, propertyName) {
    ...
    if (this.targetEntitiesPos == null) return false;else {
...
AbstractReferenceComponent.ɵfac = function AbstractReferenceComponent_Factory(t) {
  return new (t || AbstractReferenceComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeModelManager, 8), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeStoreManager, 8));
};
AbstractReferenceComponent.ɵcmp = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
  ...
  dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.NgIf, primeng_dropdown__WEBPACK_IMPORTED_MODULE_4__.Dropdown, primeng_api__WEBPACK_IMPORTED_MODULE_6__.PrimeTemplate, _angular_forms__WEBPACK_IMPORTED_MODULE_1__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_1__.NgControlStatusGroup, _angular_forms__WEBPACK_IMPORTED_MODULE_1__.FormGroupDirective, _angular_forms__WEBPACK_IMPORTED_MODULE_1__.FormControlName],
  changeDetection: 0
});
(function () {
...
EntityStoreService.ɵfac = function EntityStoreService_Factory(t) {
  return new (t || EntityStoreService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeStoreManager), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeModelManager));
};
EntityStoreService.ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
  token: EntityStoreService,
  factory: EntityStoreService.ɵfac,
  providedIn: 'root'
});
(function () {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EntityStoreService, [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_0__.Injectable,
    args: [{
      providedIn: 'root'
    }]
...
class EntityListManager {
  ...
  loadAll() {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.firstValueFrom)(this.storeMgr.searchEntities(this.pointer.position).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.map)(values => {
      this.prepared = null;
  ...
  searchAndPrepareEntities(sort, groupBy, dataTransformer, ...criteria) {
    ...
    const groupByStore = listOfValues.length > 0 ? new _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeStoreGroupby(listOfValues[0].of, listOfValues[0].display, listOfValues[0].show) : undefined;
    if (this.entities != null) {
      this.prepared = null;
      // Already loaded, just sort & group
      let sortedValues = this.entities;
      let groupedValues = undefined;
      if (criteria != null) sortedValues = _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.StoreProviderHelper.applyFilters(sortedValues, ...criteria);
      if (sortStore != null) {
        sortedValues = _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.StoreProviderHelper.multiSortArray(sortedValues, sortStore);
      }
      if (groupByStore != null) {
        groupedValues = _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.StoreProviderHelper.calculateGroupedByValues(sortedValues, groupByStore, this.modelMgr, this.pointer);
      }
      if (criteria != null || sort != null || groupBy != null) {
        this.prepared = new _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeStorePreparedEntities(sortedValues, sortStore, groupedValues);
      }
      return Promise.resolve();
    } else {
      // Not loaded already, just ask the store to do it
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.firstValueFrom)(this.storeMgr.searchAndPrepareEntities(this.pointer.position, sortStore, groupByStore, dataTransformer, ...criteria).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.map)(value => {
        this.prepared = value;
...
ValueService.ɵfac = function ValueService_Factory(t) {
  return new (t || ValueService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeModelManager));
};
  ...
  static forRoot() {
    return {
      ...
      providers: [{
        ...
        useValue: _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.dtcde
      }, {
        provide: _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeSchemaManager,
        useValue: _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.dtcde.getSchemaManager()
      }, {
        provide: _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeModelManager,
        useValue: _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.dtcde.getModelManager()
      }, {
        provide: _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodePreviewManager,
        useValue: _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.dtcde.getPreviewManager()
      }, {
        provide: _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeStoreManager,
        useValue: _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.dtcde.getStoreManager()
      }, {
        provide: _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.DontCodeChangeManager,
        useValue: _dontcode_core__WEBPACK_IMPORTED_MODULE_3__.dtcde.getChangeManager()
      }, BeautifierPipe]
    };
  }
}
...
PluginCommonModule.ɵinj = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
  imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule, primeng_dropdown__WEBPACK_IMPORTED_MODULE_4__.DropdownModule, _angular_forms__WEBPACK_IMPORTED_MODULE_1__.ReactiveFormsModule]
});
(function () {
