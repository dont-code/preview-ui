...
/* harmony import */ var _dontcode_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @dontcode/core */ 6282);
 ...
 */
const DONT_CODE_COMMON_CONFIG = new _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectionToken('DontCodeCommonLibConfig');
...
class CommonConfigService {
  constructor(config) {
    this.updates = new rxjs__WEBPACK_IMPORTED_MODULE_9__.ReplaySubject(1);
    this.config = config;
...
CommonConfigService.ɵfac = function CommonConfigService_Factory(t) {
  return new (t || CommonConfigService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](DONT_CODE_COMMON_CONFIG, 8));
};
