...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! rxjs */ 635);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! rxjs */ 4363);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! rxjs */ 8947);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! rxjs */ 9346);
...
class Action extends Change {
  constructor(position, value, context, actionType, pointer, running, changeType) {
    ...
    this.running = new rxjs__WEBPACK_IMPORTED_MODULE_12__.Subject();
...
class DontCodeChangeManager {
  ...
  createNewListener(position, property) {
    ...
    if (item.observed == true) {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_13__.throwError)(() => new Error("Several components listen to the same position {" + position + ', ' + property));
    }
...
class AbstractDontCodeStoreProvider {
   ...
   */
  searchEntities(position, ...criteria) {
    return this.listEntities(position).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_14__.map)(value => {
  ...
  searchAndPrepareEntities(position, sort, groupBy, transformer, ...criteria) {
    return this.searchEntities(position, ...criteria).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_14__.map)(value => {
      // Run the transformation if any
      if (transformer != null) return transformer.postLoadingTransformation(value);else return value;
    }), (0,rxjs__WEBPACK_IMPORTED_MODULE_14__.map)(value => {
      let groupedByValues;
...
class DontCodeTestManager {
  ...
  */
  ...
  static waitUntilTrueAndEmit(tester, interval, maxTry) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_15__.firstValueFrom)((0,rxjs__WEBPACK_IMPORTED_MODULE_16__.timer)(interval, interval).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_17__.take)(maxTry), (0,rxjs__WEBPACK_IMPORTED_MODULE_18__.filter)(() => {
      return tester();
...
class DummyStoreProvider extends AbstractDontCodeStoreProvider {
  ...
  searchEntities(position, ...criteria) {
    if (Array.isArray(this.content)) {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_19__.from)([this.content]);
    } else {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_19__.from)([[this.content]]);
    }
  }
  storeDocuments(toStore, position) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_13__.throwError)(() => new Error("Not implemented by Dummy tester"));
  }
  storeEntity(position, entity) {
    return Promise.reject("Not implemented by Dummy tester");
  }
